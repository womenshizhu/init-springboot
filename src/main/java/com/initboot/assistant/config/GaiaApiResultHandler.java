...
import com.initboot.assistant.annotation.ApiResultIgnore;
import com.initboot.assistant.dto.ResultData;
...
public class GaiaApiResultHandler implements ResponseBodyAdvice {
    ...
    public boolean supports(MethodParameter returnType, Class converterType) {
        ...
        if (!returnType.getContainingClass().toString().contains("initboot")) {
            return false;
        } else {
